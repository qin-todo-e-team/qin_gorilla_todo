...
export const Terms: React.VFC = () => (
  <div className="my-6">
    ...
    <ol>
      ...
      <li>
        ユーザーが本サービスを利用するには、ニックネーム、メールアドレス、パスワード等の登録、又は本サービスが指定する第三者の発行するID及びパスワードを求められることがあります。
      </li>
      <li>
    ...
    <ol>
      <li>
        ...
        <ul>
          ...
          <li>他のユーザー又は第三者になりすまして本サービスを利用する行為</li>
          <li>
          ...
          <li>
            チートツール、BOT、その他の技術を利用して本サービスを不正に操作する行為
          </li>
          <li>本サービスに発生した不具合を意図的に利用する行為</li>
          <li>
            ジェイルブレイク等、端末に対して改変を行った状態での本サービスへのアクセス行為
          </li>
          <li>
          ...
          <li>その他本サービスにて本サービスが不正と判断する行為</li>
        ...
        <li>
          本サービスは、本条第1項各号の行為をユーザーが行うこと、又は受けることによって、他のユーザー又は第三者との間でトラブルが生じた場合、当該ユーザーは、自己の責任と費用においてこれを解決し、本サービスは一切の責任を負わないものとします。この場合において、本サービス又は第三者が何らかの損害を被ったときは、当該ユーザーは本サービス及び当該第三者に対して損害の賠償をしなければならないものとします。
        </li>
      </li>
    </ol>
    <h4>第７条 免責事項</h4>
    ...
    <h4>第９条 知的財産権の帰属</h4>
    <p>
      本サービスに関する特許権、実用新案権、意匠権、著作権等（著作権法第27条及び第28条に規定する権利を含む。以下本条において総称して「知的財産権」といいます）は、本サービス又は正当な権利を有する第三者に帰属します。
    </p>
    <h4>第１０条 ユーザーへの通知</h4>
    <ol>
      <li>
    ...
    <ol>
      ...
      <li>
        ユーザーが第1項各号（第4号、第5号を除く）のいずれかに該当することにより本サービスが損害を被った場合、本サービスは当該ユーザーに対して損害の賠償を請求できるものとします。
      </li>
    </ol>
    <h4>第１３条 利用終了</h4>
    <ol>
